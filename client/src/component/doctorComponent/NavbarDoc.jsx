...
const NavbarDoc = () => {
    ...
    return (
        <>
            <div className="bg-white h-20 w-full flex justify-between items-center text-red-500 font-bold absolute top-0">
                <div className="flex justify-between items-center h-full w-full px-5 relative">
                    ...
                    <div className="sm:hidden">
                        ...
                        <div className="absolute h-80 w-64 bg-white top-0 right-0 p-4" style={showSidenav}>
                            <div className="h-full w-full relative flex justify-center items-center">
                                ...
                                <div className="flex flex-col justify-center items-center gap-6 mt-12 mb-5">
                                    ...
                                    <div className="hover:text-black">Blog</div>
                                    <div className="hover:text-black">Contant Adimn</div>
                                </div>
                            </div>
                        </div>
                    </div>
